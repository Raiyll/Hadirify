...
<body class="min-h-screen bg-gray-50 font-sans antialiased" style="font-family: 'Inter', sans-serif;">
    <div
        ...
        <div
            ...
            <div
                class="md:w-5/12 bg-gradient-to-br from-purple-600 via-indigo-600 to-blue-500 p-8 text-white flex flex-col justify-between relative overflow-hidden bg-gradient-animate">

                <div class="absolute -bottom-32 -right-32 h-64 w-64 rounded-full bg-indigo-500 bg-opacity-20 floating">
                </div>
                <div
                    class="absolute -bottom-40 -right-40 h-80 w-80 rounded-full bg-purple-500 bg-opacity-20 floating-delay-1">
                </div>
                <div
                    class="absolute top-1/4 -left-20 h-40 w-40 rounded-full bg-blue-400 bg-opacity-15 floating-delay-2">
                </div>
                ...
                <div class="mt-auto pt-16 relative z-10 animate__animated animate__fadeIn animate__delay-2s">
                    <p class="text-sm text-indigo-200">Sudah punya akun?
                        <a href="login.html" class="font-medium text-white hover:underline transition-all">Masuk
                            disini</a>
                    </p>
                                ...
                                <div class="relative rounded-md shadow-sm">
                                    ...
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
                                        <button type="button" onclick="toggleConfirmPassword()"
                                            class="focus:outline-none hover:scale-110 transition-transform">
                                            <i id="confirm-eye-icon" data-feather="eye"
                                                class="h-5 w-5 text-gray-400 hover:text-indigo-600"></i>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="ml-3 text-sm">
                                    <label for="terms"
                                        ...
                                        Saya menyetujui <a href="#"
                                            class="text-indigo-600 hover:text-indigo-500 hover:underline">Syarat &
                                            Ketentuan</a> dan <a href="#"
                                            class="text-indigo-600 hover:text-indigo-500 hover:underline">Kebijakan
                                            Privasi</a>
                                    </label>
                                </div>
                            </div>
